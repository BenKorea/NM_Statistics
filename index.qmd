...
::: {.callout-note title="10단계: API 테스트" collapse="true" appearance="minimal"}
...
```
::: {.callout-note title="11단계: PageNo 반복호출하기" collapse="true" appearance="minimal"}
...
-     위 코드의 문제는 호출한도를 초과한다는 것이다. 일일 트래픽이 10000건으로 제한되어 있기 때문이다.
